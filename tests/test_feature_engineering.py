...
class TestFeatureEngineering:
    ...
    def sample_dataframe(self):
        ...
        return create_fraud_dataset(n_samples=200)
    ...
    def test_amount_features(self, sample_dataframe):
        ...
        # Check new columns exist (actual implementation names)
    ...
    def test_statistical_features(self, sample_dataframe):
        ...
        assert "v_outliers_3sigma" in df_with_stats.columns
    ...
    def test_transform_new_data(self, sample_dataframe):
        ...
        # Transform a fresh sample with same schema
        new_data = create_fraud_dataset(n_samples=50)
        transformed_new = fe.transform(new_data)
        assert len(transformed_new) == len(new_data)
        assert transformed_new.shape[1] == df_transformed.shape[1]
